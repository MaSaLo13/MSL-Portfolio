    ...
    <div className="containers2 py-5">
        ...
        <div className="row py-4 text-dark">
            <div className=" d-flex justify-content-evenly p-2 flex-wrap">
                ...
                <h3><iconify-icon icon="logos:heroku-icon" width="50" height="50"></iconify-icon></h3>                <h3><iconify-icon icon="vscode-icons:file-type-reactjs" width="50" height="50"></iconify-icon></h3>
