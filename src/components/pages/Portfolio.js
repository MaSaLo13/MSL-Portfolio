  ...
  <div className="col">
    <div className="card">
      ...
      <div className="card-body">
        ...
        <a className="btn btn-outline-dark btn-floating m-1" href="https://github.com/MaSaLo13/Weather-Dash" role="button"
        ><i className="fab fa-github"></i></a>
        <a className="btn btn-outline-dark btn-floating m-1" href="https://masalo13.github.io/Weather-Dash/" role="button"
  ...
  <div className="col">
    <div className="card">
      ...
      <div className="card-body">
        ...
        <a className="btn " href="https://github.com/GSiggins/ingredients" role="button"
        ><i className="fab fa-github"></i></a>
        <a className="btn " href="https://gsiggins.github.io/ingredients/" role="button"
